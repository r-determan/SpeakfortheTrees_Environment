...
s_temp <- ggplot(data = jn, aes(fill = mn_tmp_s)) +
  ...
  scale_fill_distiller(palette = "YlOrBr",trans = "reverse") +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black")) +theme_void()
s_temp <- ggarrange(temp, s_temp, ncol=2, common.legend = TRUE, legend = "right")
...
cnp <- ggplot(data = jn, aes(fill = Tre_Cnp)) +
  geom_sf() +
  labs(title="Tree_Canopy") +
  scale_fill_distiller(palette = "Greens",trans = "reverse") +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black")) + theme_void()

s_cnp <- ggplot(data = jn, aes(fill = mn_cnp_s)) +
  geom_sf() +
  labs(title="Smooth_Tree_Canopy") +
  scale_fill_distiller(palette = "Greens",trans = "reverse") +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"))  + theme_void()
s_cnp <- ggarrange(cnp, s_cnp, ncol=2, common.legend = TRUE, legend = "right")
s_temp
pm25
s_cnp 
ggsave("Figure3_blockTemp.png", s_temp)
ggsave("Figure4_blockPM25.png", pm25, width = 16, height = 9)
ggsave("Figure5_blockTreecnp.png", s_cnp, width = 16, height = 9)
```
